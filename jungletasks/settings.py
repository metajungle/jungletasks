...
DATABASES = {
    'default': {
        ...
        'NAME': 'tasks.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '_iqybaq*g(v=tg^1lt18wqjf+r30yca+6tib$8ddq3t=c(#i20'
...
ROOT_URLCONF = 'jungletasks.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'jungletasks.wsgi.application'
